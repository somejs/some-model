 ...
 */
var Model= module.exports= function(properties) {
    ...
    this.db= Schema.Property({ enumerable:false, require:true })
    this.key= Schema.Property({ enumerable:false, require:true })


    this.title= Schema.Property({ verbose:'название' })

    this.created= Schema.Property({ verbose:'дата создания' })
    this.updated= Schema.Property({ verbose:'дата обновления' })


    Schema.call(this, properties)
}
inherits(Model, Schema)
